...
namespace eCommerce.Core.Common
{
    ...
    /// <remarks>http://blogs.clariusconsulting.net/kzu/simplified-inotifypropertychanged-implementation-with-weakreference-support-and-typed-property-access-api/</remarks>
